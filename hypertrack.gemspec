Gem::Specification.new do |spec|
  ...
  spec.files       = Dir['lib/*.rb'] + Dir['lib/hypertrack/*.rb'] + Dir['lib/hypertrack/api_operations/*.rb'] + Dir['lib/hypertrack/api_operations/common/*.rb'] + Dir['lib/hypertrack/resources/*.rb']
